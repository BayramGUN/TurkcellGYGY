...
{   
    private const string connecitonString = "Server=localhost,1433;Database=MovieDb;User=sa;Password=yourStrong(!)Password;TrustServerCertificate=True;Trusted_Connection=False;Encrypt=False;Trusted_Connection=False;MultipleActiveResultSets=True";
